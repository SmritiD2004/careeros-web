...
const TargetCursor = ({
  ...
  return (
    <div
      ref={cursorRef}
      className={`${styles.targetCursorWrapper} target-cursor-wrapper`}
    >
      <div
        ref={dotRef}
        className={`${styles.targetCursorDot} target-cursor-dot`}
        style={{ backgroundColor: cursorColor }}
      />
      <div
        className={`${styles.targetCursorCorner} ${styles.cornerTl} target-cursor-corner corner-tl`}
        style={{ borderColor: cursorColor }}
      />
      <div
        className={`${styles.targetCursorCorner} ${styles.cornerTr} target-cursor-corner corner-tr`}
        style={{ borderColor: cursorColor }}
      />
      <div
        className={`${styles.targetCursorCorner} ${styles.cornerBr} target-cursor-corner corner-br`}
        style={{ borderColor: cursorColor }}
      />
      <div
        className={`${styles.targetCursorCorner} ${styles.cornerBl} target-cursor-corner corner-bl`}
        style={{ borderColor: cursorColor }}
      />
    </div>
  );
