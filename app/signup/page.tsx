    ...
    <div className="relative min-h-screen overflow-hidden bg-zinc-950 text-white">
      ...
      <main className="relative z-10 mx-auto grid min-h-screen max-w-7xl items-center gap-10 px-6 py-10 lg:grid-cols-[1.2fr_0.9fr] lg:px-8">
        <section className="max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/4 px-4 py-2 text-[11px] font-medium uppercase tracking-[0.32em] text-zinc-300">
            <span className="size-2 rounded-full bg-orange-500 shadow-[0_0_18px_rgba(249,115,22,0.8)]" />
            CareerOS • Create your account
          </div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-400 md:text-xl">
            Start tracking DSA, internships, certifications, and project proof in one command center.
          </p>
            ...
            {[
              ["1", "Profile to create"],
              ["3", "Core integrations"],
              ["24/7", "Momentum tracking"],
              ["0", "Setup friction"],
            ].map(([value, label]) => (
              <div key={label} className="rounded-3xl border border-white/10 bg-white/4 p-5 backdrop-blur-sm">
          ...
          <div className="relative rounded-[2rem] border border-white/10 bg-zinc-950/90 p-6 shadow-[0_30px_120px_rgba(0,0,0,0.55)] backdrop-blur-xl">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <button className="flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/3 px-4 py-3 text-sm font-medium text-white transition hover:bg-white/6">
              ...
              <div className="space-y-3">
                <label className="block">
                  ...
                  <Input
                      ...
                      className="h-11 rounded-2xl border-white/10 bg-white/3 text-white placeholder:text-zinc-500"
                    />
                </label>
                <label className="block">
                  <span className="mb-2 block text-[11px] uppercase tracking-[0.28em] text-zinc-500">
              ...
              <Link
                href="/dashboard"
                className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-linear-to-r from-orange-500 to-amber-400 px-5 py-3.5 text-sm font-semibold text-black shadow-[0_20px_70px_rgba(249,115,22,0.35)] transition hover:brightness-110"
              >
