      ...
      <main className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center px-6 py-16 lg:px-8">
        <div className="grid w-full gap-12 lg:grid-cols-[1.25fr_0.9fr] lg:items-center">
          <section className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-[11px] font-medium uppercase tracking-[0.32em] text-zinc-300 shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              <Link
                href="/login"
                className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-400 px-6 py-3 text-sm font-semibold text-black shadow-[0_20px_70px_rgba(249,115,22,0.35)] transition hover:brightness-110"
              >
                Enter CareerOS <ArrowRight className="size-4" />
              </Link>
              <Link
                href="/dashboard"
                className="inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-white/[0.04] px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/8"
              >
                Preview dashboard
              </Link>
            </div>
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-zinc-950/85 p-6 shadow-[0_30px_120px_rgba(0,0,0,0.55)] backdrop-blur-xl">
              ...
              <div className="rounded-[1.75rem] border border-white/8 bg-white/[0.03] p-5">
                ...
                <div className="mt-6 h-2 overflow-hidden rounded-full bg-white/10">
                  <div className="h-full w-[79%] rounded-full bg-gradient-to-r from-orange-500 to-amber-300" />
                </div>
              </div>
            </div>
          </aside>
